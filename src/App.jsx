...
const App = () => {
  ...
  const [currentColor2, setCurrentColor2] = useState("bronze");

  const images = {
    red: "https://raw.githubusercontent.com/Elshod701/imgs/main/images/1.png",
    orange:
      "https://raw.githubusercontent.com/Elshod701/imgs/main/images/2.png",
    gray: "https://raw.githubusercontent.com/Elshod701/imgs/main/images/3.png",
    black: "https://raw.githubusercontent.com/Elshod701/imgs/main/images/4.png",
  };
  const images2 = {
    bronze:
      "https://raw.githubusercontent.com/Elshod701/imgs/main/images/6.png",
    white: "https://raw.githubusercontent.com/Elshod701/imgs/main/images/7.png",
    gray: "https://raw.githubusercontent.com/Elshod701/imgs/main/images/8.png",
    black: "https://raw.githubusercontent.com/Elshod701/imgs/main/images/9.png",
  };
          ...
          <div className="container">
            <div className="flex items-center justify-between">
              ...
              <div className="w-full h-[420px] relative">
                ...
                />
                <p className="absolute bg-[#FF9549] text-base w-[150px] p-2 font-tank-medium text-center rounded-lg top-[20px] right-[150px] rotate-[25deg]">
                  Осталось 5 автомобилей по спец цене
                </p>
                <div className="flex flex-col items-center justify-center gap-2 absolute top-20 right-10">
                  <button
                    id="tank-red-button"
                  ...
                  <button
                    id="tank-gray-button"
                    className={currentColor === "gray" ? "active" : ""}
                    onClick={() => setCurrentColor("gray")}
                    style={{ backgroundColor: "gray" }}
                  ></button>
                  <button
                    id="tank-black-button"
                    className={currentColor === "black" ? "active" : ""}
          ...
          <div className="container">
            <div className="flex items-center justify-between">
              <div className="w-full h-[420px] relative">
                <img
                  className="mx-auto block"
                  src={images2[currentColor2]}
                  alt={`${currentColor2} color`}
                />
                <p className="absolute bg-[#FF9549] text-base w-[150px] p-2 font-tank-medium text-center rounded-lg top-[20px] right-[150px] rotate-[25deg]">
                  Осталось 5 автомобилей по спец цене
                </p>
                <div className="flex flex-col items-center justify-center gap-2 absolute top-20 left-10">
                  <button
                    id="tank2-bronze-button"
                    className={currentColor2 === "bronze" ? "active" : ""}
                    onClick={() => setCurrentColor2("bronze")}
                    style={{ backgroundColor: "bronze" }}
                  ></button>
                  <button
                    id="tank2-white-button"
                    className={currentColor === "white" ? "active" : ""}
                    onClick={() => setCurrentColor2("white")}
                    style={{ backgroundColor2: "white" }}
                  ></button>
                  <button
                    id="tank2-gray-button"
                    className={currentColor2 === "gray" ? "active" : ""}
                    onClick={() => setCurrentColor2("gray")}
                    style={{ backgroundColor: "gray" }}
                  ></button>
                  <button
                    id="tank2-black-button"
                    className={currentColor2 === "black" ? "active" : ""}
                    onClick={() => setCurrentColor2("black")}
                    style={{ backgroundColor: "black" }}
                  ></button>
                </div>
              </div>
